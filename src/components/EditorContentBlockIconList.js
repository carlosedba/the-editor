...
import { DND_EDITOR_SIDEBAR_BLOCK_ICON_LIST } from '@/dndTypes'

export default function EditorContentBlockIconList(props) {
  useFeather()

  const DND_TYPE = DND_EDITOR_SIDEBAR_BLOCK_ICON_LIST
  ...
  function renderItems() {
    ...
    return content.map((item, i) => {
      return (
        <div className="editor-content-block-icon-list-item" key={i}>
          <div className="editor-content-block-icon-list-item__icon" onContextMenu={(event) => show({ event: event, props: item })}>
