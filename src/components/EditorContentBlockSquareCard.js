...
import { DND_EDITOR_SIDEBAR_BLOCK_SQUARE_CARD } from '@/dndTypes'

export default function EditorContentBlockSquareCard(props) {
  useFeather()

  const DND_TYPE = DND_EDITOR_SIDEBAR_BLOCK_SQUARE_CARD
  ...
  function renderItems() {
    return content.map((item, i) => {
      return (
        <div className="editor-content-block-square-card-item" key={i}>
          <div className="editor-content-block-square-card-item__icon" onContextMenu={(event) => show({ event: event, props: item })}>
